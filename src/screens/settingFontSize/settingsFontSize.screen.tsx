...
import {setSizeText} from 'store/reducer/system.reducer.store';
...
const SettingsFontSizeScreen = () => {
    const {styles, theme} = useSystem(createStyles)

    const sizeText = useAppSelector(state => state.system.sizeText)
    const refTypingText = useRef<any>()
    const translateX = useSharedValue(((sizeText - 0.9) * 10) * (WIDTH / 4) - WIDTH_BOX / 2)
    ...
    const setSize = (sp) => {
        dispatch(setSizeText(0.9 + (sp / 10)))
    }
    ...
    return (
        <View style={styles.container}>
            <View style={[styles.row]}>
                <TextBase title={languages.sizeTextDisplay} fontSize={16}
                          style={{marginHorizontal: -HS._20, marginBottom: VS._20}} fontWeight="600"/>
                <View style={styles.slide}>
                    <Animated.View
                        style={[{...StyleSheet.absoluteFillObject, backgroundColor: theme.backgroundMain}, styleView]}/>
                    <View/>
                </View>
                ...
                <View style={styles.range}>
                    <View style={{alignItems: "center"}}>
                        ...
                        <TextBase title={"1"} fontSize={FontSizes._16} fontWeight="600"/>
                    </View>
                    <View style={{alignItems: "center"}}>
                        <View style={styles.rangeItem}/>
                        <TextBase title={"2"} fontSize={FontSizes._16} fontWeight="600"/>
                    </View>
                    <View style={{alignItems: "center"}}>
                        <View style={styles.rangeItem}/>
                        <TextBase title={"3"} fontSize={FontSizes._16} fontWeight="600"/>
                    </View>
                    <View style={{alignItems: "center"}}>
                        <View style={styles.rangeItem}/>
                        <TextBase title={"4"} fontSize={FontSizes._16} fontWeight="600"/>
                    </View>
                    <View style={{alignItems: "center"}}>
                        <View style={styles.rangeItem}/>
                        <TextBase title={"5"} fontSize={FontSizes._16} fontWeight="600"/>
                    </View>
                </View>
            </View>
            <View style={[styles.messageBubble]}>
                <TextBase title={QUOTE}/>
            </View>
        </View>
    )
}
